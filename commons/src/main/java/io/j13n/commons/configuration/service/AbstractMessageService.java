...
import io.j13n.commons.exeception.GenericException;
import io.j13n.commons.utils.StringFormatter;
...
public class AbstractMessageService {
    ...
    public String getMessage(String messageId, Object... params) {
        return StringFormatter.format(getMessage(messageId), params);
    }
    ...
    public <T> void throwMessage(Function<String, GenericException> genericExceptionFunction, String messageId,
                                 Object... params) {
        String message = getMessage(messageId, params);
        throw genericExceptionFunction.apply(message);
    }
